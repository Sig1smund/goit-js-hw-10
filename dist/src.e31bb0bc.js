...
},{}],"fetcher.js":[function(require,module,exports) {
"use strict";
...
var coutriesToFetch = /*#__PURE__*/function () {
  function coutriesToFetch() {
    _classCallCheck(this, coutriesToFetch);

    this.countryToFind = "";
  }

  _createClass(coutriesToFetch, [{
    key: "fetchCountries",
    value: function fetchCountries(name) {
      return fetch("https://restcountries.com/v3.1/name/".concat(name, "?fields=name,capital,flags,languages,population")).then(function (r) {
        if (!r.ok) {
    ...
    set: function set(newSearchName) {
      this.countryToFind = newSearchName;
    }
  }]);

  return coutriesToFetch;
}();

exports.default = coutriesToFetch;
},{"notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.2.2.min.js"}],"../node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
var inputForm = document.getElementById("search-box");
var countryList = document.querySelector(".country-list");
var countryInfo = document.querySelector(".country-info");
var countriesFetcher = new _fetcher.default();
var country = "";
inputForm.addEventListener("input", (0, _lodash.debounce)(onSearch, DEBOUNCE_DELAY));
...
function onSearch(event) {
  ...
  if (country !== "") {
    countriesFetcher.fetchCountries(country).then(function (data) {
      createMarkup(data);
    });
  }
}
...
function getCountryList(data) {
  var markup = data.map(function (item) {
    return "<li class=\"country-list-item\">\n        <img\n          class=\"flag-list\"\n          src=\"".concat(item.flags.svg, "\"\n          alt=\"flag\"\n          width='250'\n        />\n        <h2 class=\"list-item-h2\">").concat(item.name.official, "</h2>\n      </li>");
  }).join("");
...
function addCountryInfo(data) {
  var markup = data.map(function (item) {
    return "<div class=\"flag-country-block\">\n        <img\n          class=\"flag\"\n          src=\"".concat(item.flags.svg, "\"\n          alt=\"flag\"\n          width='250'\n        />\n        <h1>").concat(item.name.official, "</h1>\n      </div>\n      <ul class=\"country-info-details\">\n        <li class=\"country-info-item\">\n          <h2>Capital:</h2>\n          <p class=\"info-value\">").concat(item.capital, "</p>\n        </li>\n        <li class=\"country-info-item\">\n          <h2>Population:</h2>\n          <p class=\"info-value\">").concat(item.population, "</p\n          >\n        </li>\n        <li class=\"country-info-item\">\n          <h2>Languages:</h2>\n          <p class=\"info-value\">").concat(Object.values(item.languages), "</p>\n        </li>\n      </ul>");
  }).join("");
...
},{"./fetcher":"fetcher.js","lodash":"../node_modules/lodash/lodash.js","./css/styles.css":"css/styles.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
